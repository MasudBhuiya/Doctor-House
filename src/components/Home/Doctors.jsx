                ...
                <div className="card w-96 lg:w-80 xl:w-96 bg-base-100 shadow-xl border">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <button className="btn btn-outline btn-block text-orange-300 hover:bg-orange-100 hover:border-orange-300">View Profile</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 lg:w-80 xl:w-96 bg-base-100 shadow-xl border">
                    ...
                    <div className="card-body">
                        ...
                        <p className='flex items-center '><span className='text-xl me-3'><RiMoneyDollarCircleLine /></span> $15</p>
                        <div className="card-actions justify-end">
                            <button className="btn bg-orange-300 text-white btn-block hover:bg-orange-400 hover:border-orange-300">View Profile</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 lg:w-80 xl:w-96 bg-base-100 shadow-xl border">
